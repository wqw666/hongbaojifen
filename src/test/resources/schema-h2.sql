-- H2 测试库结构（与 MySQL 迁移 V1__init.sql 保持一致）
CREATE TABLE IF NOT EXISTS members (
    ...
    note VARCHAR(255) DEFAULT '', created_at VARCHAR(19) DEFAULT '', updated_at VARCHAR(19) DEFAULT ''
);
CREATE TABLE IF NOT EXISTS point_records (
    ...
    biz_no VARCHAR(64) DEFAULT NULL, created_at VARCHAR(19) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS qq_groups (
    ...
    group_name VARCHAR(128) DEFAULT '', owner_qq VARCHAR(32) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS executors (
    ...
    group_id VARCHAR(32) DEFAULT '', last_heartbeat VARCHAR(19) DEFAULT '',
    note VARCHAR(255) DEFAULT '', created_at VARCHAR(19) DEFAULT '', updated_at VARCHAR(19) DEFAULT ''
);
